...
- Name: materials/create-material.spec.js >> Create Material — Real Backend (dev profile) >> T1 — tạo material với đầy đủ tất cả fields
- Location: e2e/materials/create-material.spec.js:56:3
...
Call log:
  ...
  - waiting for locator('[role="dialog"]')
    9 × locator resolved to <div role="dialog" class="modal " aria-modal="true">…</div>
...
- generic [ref=e3]:
  ...
  - main [ref=e38]:
    ...
    - dialog [ref=e267]:
      - generic [ref=e268]:
        - generic [ref=e269]: ➕ Thêm vật tư mới
        - button "Close" [ref=e270] [cursor=pointer]: ✕
      - generic [ref=e272]:
        - generic [ref=e273]:
          - generic [ref=e274]: ⚠ An unexpected error occurred
          - generic [ref=e275]:
            - generic [ref=e276]:
              - generic [ref=e277]: Part Number *
              - 'textbox "VD: MAT-001" [ref=e278]': MAT-E2E-1775206676544-903
            - generic [ref=e279]:
              - generic [ref=e280]: Loại vật tư *
              - combobox [ref=e281]:
                - option "API"
                - option "Excipient" [selected]
                - option "Packaging"
                - option "Product"
                - option "Other"
            - generic [ref=e282]:
              - generic [ref=e283]: Tên vật tư *
              - textbox "Tên đầy đủ của vật tư" [ref=e284]: E2E Full Fields Material
            - generic [ref=e285]:
              - generic [ref=e286]: Điều kiện bảo quản
              - 'textbox "VD: Bảo quản 2–8°C, tránh ánh sáng" [ref=e287]': Store at 2-8°C
            - generic [ref=e288]:
              - generic [ref=e289]: Tài liệu đặc tính (URL/Path)
              - textbox "Link hoặc đường dẫn tài liệu" [ref=e290]: https://docs.example.com/spec-e2e
        - generic [ref=e291]:
          - button "Huỷ" [ref=e292] [cursor=pointer]
          - button "➕ Thêm mới" [ref=e293] [cursor=pointer]
```
